...
This command requires Python package [cnloc](https://github.com/maobin-xu/cnloc).
...
Command syntax:
```stata
cnloc address_var [ year_var] [if] [in] [, year(str) mode(str) drop(str) prefix(str) suffix(str) ]
```
